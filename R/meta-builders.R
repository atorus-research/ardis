#' Use available metadata to build the ardis_meta object
#'
...
#' @param treat_grps Treatment groups from the ardis parent environment
...
#'
#' @param meta A ardis_metadata object
