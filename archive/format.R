...
#'   being performed. 'ardis' makes this process as simple as we can, while
#'   still allowing flexibility to the user.
#'
#'   ardis provides both manual and automatic decimal precision formatting. The
...
#'   string as 'xx.xxx'. 'ardis' does the work to get the numbers in the right
#'   place.
#'
...
#'
#'   An `f_str()` may also be used outside of a ardis table. The function
